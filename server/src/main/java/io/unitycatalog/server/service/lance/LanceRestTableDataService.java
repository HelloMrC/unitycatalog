...
public class LanceRestTableDataService {
  ...
  public HttpResponse queryTable(
    ...
    return json(backend.query(command("query", id, delimiter)));
  }

  @Post("/v1/table/{id}/count_rows")
  public HttpResponse countRows(
      @Param("id") String id, @Param("delimiter") Optional<String> delimiter, HttpRequest request) {
    return json(backend.countRows(command("count_rows", id, delimiter)));
  }

  @Post("/v1/table/{id}/stats")
  public HttpResponse stats(
      @Param("id") String id, @Param("delimiter") Optional<String> delimiter, HttpRequest request) {
    return json(backend.stats(command("stats", id, delimiter)));
  }

  @Post("/v1/table/{id}/insert")
  public HttpResponse insert(
      @Param("id") String id, @Param("delimiter") Optional<String> delimiter, HttpRequest request) {
    return json(backend.insert(command("insert", id, delimiter)));
  }

  @Post("/v1/table/{id}/merge_insert")
  public HttpResponse mergeInsert(
      @Param("id") String id, @Param("delimiter") Optional<String> delimiter, HttpRequest request) {
    return json(backend.mergeInsert(command("merge_insert", id, delimiter)));
  }

  @Post("/v1/table/{id}/update")
  public HttpResponse update(
      @Param("id") String id, @Param("delimiter") Optional<String> delimiter, HttpRequest request) {
    return json(backend.update(command("update", id, delimiter)));
  }

  @Post("/v1/table/{id}/delete")
  public HttpResponse delete(
      @Param("id") String id, @Param("delimiter") Optional<String> delimiter, HttpRequest request) {
    return json(backend.delete(command("delete", id, delimiter)));
  }

  @Post("/v1/table/{id}/explain_plan")
  public HttpResponse explainPlan(
      @Param("id") String id, @Param("delimiter") Optional<String> delimiter, HttpRequest request) {
    return json(backend.explainPlan(command("explain_plan", id, delimiter)));
  }

  @Post("/v1/table/{id}/analyze_plan")
  public HttpResponse analyzePlan(
      @Param("id") String id, @Param("delimiter") Optional<String> delimiter, HttpRequest request) {
    return json(backend.analyzePlan(command("analyze_plan", id, delimiter)));
  }

  @Post("/v1/table/{id}/create")
  public HttpResponse create(
      @Param("id") String id, @Param("delimiter") Optional<String> delimiter, HttpRequest request) {
    return json(backend.create(command("create", id, delimiter)));
  }
  ...
  private HttpResponse json(LanceExecutionResult result) {
    return HttpResponse.ofJson(result.payload());
  }
}
